...
<style>
                ...
                <div class="col-lg-12">
                    <div class="single_element">
                        <div class="quick_activity">
                            <div class="row">
                                <div class="col-12">
                                    <div class="quick_activity_wrap" style=" display: grid; grid-template-columns: repeat(3, 1fr); gap: 20px;">
                                        <!-- single_quick_activity  -->
                                        <div class="single_quick_activity">
                                            <div class="count_content">
                                                <p>Jumlah Tempat Sampah Aktif</p>
                                                <h3><span class="counter">{{ $jmlTempatSampah }}</span> </h3>
                                            </div>
                                            <div class="date-badge blue">
                                                per/{{ now()->format('Y-m-d') }}
                                            </div>
                                        </div>
                                        <div class="single_quick_activity">
                                            <div class="count_content">
                                                <p>Total Sampah Dipilah</p>
                                                <div style="display:flex; gap:20px; font-size:18px;">
                                                    <div><strong>Organik:</strong> <span id="field1Total">0</span></div>
                                                    <div><strong>Anorganik:</strong> <span id="field2Total">0</span></div>
                                                    <div><strong>Residu:</strong> <span id="field3Total">0</span></div>
                                                </div>
                                            </div>
                                            <div class="date-badge yellow">
                                                per/{{ now()->format('Y-m-d') }}
                                            </div>
                                        </div>
                                        ...
                                        <div class="single_quick_activity">
                                            <div class="count_content">
                                                <p>Jumlah Insiden (Open, In Proses)</p>
                                                <h3><span class="counter">{{ $jmlInsidenOpen }}</span></h3>
                                            </div>
                                            <div class="date-badge green">
                                                per/{{ now()->format('Y-m-d') }}
                                            </div>
                                        </div>
                                    </div>
    ...
    <script>
        function loadSumFields() {
            fetch('/api/thingspeak/sumFields')
                .then(res => res.json())
                .then(data => {
                    document.getElementById('field1Total').innerText = data.field1;
                    document.getElementById('field2Total').innerText = data.field2;
                    document.getElementById('field3Total').innerText = data.field3;
                })
                .catch(err => console.log("Gagal load API", err));
        }
        ...
        setInterval(loadSumFields, 5000);
    </script>
