...
<div class="white_card">
  <div class="white_card_header">
    <div class="box_header m-0"><div class="main-title"><h3 class="m-0">Parameter</h3></div></div>
  </div>
  ...
  <div class="white_card_body">
    <form action="{{ route('jadwalPiket.generate') }}" method="POST" class="row g-3">
      ...
      <div class="col-md-4">
        ...
        <div class="form-text">Diterapkan untuk tiap shift (Pagi/Siang/Malam) di setiap tower.</div>
      </div>
      ...
      <div class="col-12">
        ...
        <div class="form-text">Kosongkan untuk gunakan semua tower.</div>
      </div>

      <div class="col-12">
        <div class="form-check">
          <input class="form-check-input" type="checkbox" id="overwrite" name="overwrite" value="1">
          <label class="form-check-label" for="overwrite">Timpa jadwal lama di rentang tanggal</label>
        </div>
      </div>
