                                ...
                                <table class="table bayer_table m-0">
                                    <tbody>
                                      <tr style="border: hidden;">
                                        <td>
                                            <img class="byder_thumb" src="{{ asset('dashboard/images/Payment-1.png') }}" alt="">
                                        </td>
                                        <td>
                                      ...
                                      <tr style="border: hidden;">
                                        <td>
                                            <img class="byder_thumb" src="{{ asset('dashboard/images/Payment-2.png') }}" alt="">
                                        </td>
                                        <td>
                                            <div class="payment_gatway">
                                                <h5 class="byer_name  f_s_16 f_w_700 color_theme"> Deposit PayPal</h5>
                                      ...
                                      <tr style="border: hidden;">
                                        <td>
                                            <img class="byder_thumb" src="{{ asset('dashboard/images/Payment-3.png') }}" alt="">
                                        </td>
                                        <td>
                                            <div class="payment_gatway">
                                      ...
                                      <tr style="border: hidden;">
                                        <td>
                                            <img class="byder_thumb" src="{{ asset('dashboard/images/Payment-4.png') }}" alt="">
                                        </td>
                                        <td>
                                            <div class="payment_gatway">
                                      ...
                                      <tr style="border: hidden;">
                                        <td>
                                            <img class="byder_thumb" src="{{ asset('dashboard/images/Payment-5.png') }}" alt="">
                                        </td>
                                        <td>
                                            <div class="payment_gatway">
                                                <h5 class="byer_name  f_s_16 f_w_700 color_theme"> Deposit from Bank</h5>
                            ...
                            <div class="table-responsive">
                                <table class="table bayer_table2 m-0">
                                    <tbody>
                                      <tr>
                                        <td class="w_70">
                                            <img class="byder_thumb wh_56" src="{{ asset('dashboard/images/Payment-check_1.png') }}" alt="">
                                        </td>
                                        <td>
                                            <div class="payment_gatway">
                                                <h5 class="byer_name  f_s_16 f_w_700 color_theme"> Deposit PayPal</h5>
                                      ...
                                      <tr>
                                        <td>
                                            <img class="byder_thumb wh_56" src="{{ asset('dashboard/images/Payment-check_2.png') }}" alt="">
                                        </td>
                                        <td>
                                            <div class="payment_gatway">
                                                <h5 class="byer_name  f_s_16 f_w_700 color_theme"> Deposit PayPal</h5>
                                      ...
                                      <tr>
                                        <td>
                                            <img class="byder_thumb wh_56" src="{{ asset('dashboard/images/Payment-check_3.png') }}" alt="">
                                        </td>
                                        <td>
                                            <div class="payment_gatway">
                                                <h5 class="byer_name  f_s_16 f_w_700 color_theme"> Deposit from Bank</h5>
                                      ...
                                      <tr>
                                        <td>
                                            <img class="byder_thumb wh_56" src="{{ asset('dashboard/images/Payment-check_4.png') }}" alt="">
                                        </td>
                                        <td>
                                            <div class="payment_gatway">
                                                <h5 class="byer_name  f_s_16 f_w_700 color_theme"> Cancelled</h5>
                                      ...
                                      <tr>
                                        <td>
                                            <img class="byder_thumb wh_56" src="{{ asset('dashboard/images/Payment-check_5.png') }}" alt="">
                                        </td>
                                        <td>
                                            <div class="payment_gatway">
                                                <h5 class="byer_name  f_s_16 f_w_700 color_theme"> Deposit from Bank</h5>
                        ...
                        <div class="white_card_body">
                            <div class="row">
                                ...
                                <div class="col-xl-6">
                                    ...
                                    <div class="single_social_media d-flex align-items-center">
                                        <img class="img-fluid" src="{{ asset('dashboard/images/img-plane.png') }}" alt="">
                                    </div>
                        ...
                        <div class="white_card_body">
                            <div class="QA_table table-responsive ">
                                ...
                                <table class="table pt-0">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td> <img class="user_thumb" src="{{ asset('dashboard/images/invoice_img-man_1.png') }}" alt=""> </td>
                                            <td>Product</td>
                                            ...
                                            <td>High</td>
                                            <td>Oct</td>
                                            <td><img class="check_status" src="{{ asset('dashboard/images/invoice_img-check.png') }}" alt=""> </td>
                                            <td> 25/10/2020</td>
                                            <td> <button class="btn_1">PDF</button> </td>
                                        </tr>
                                        <tr>
                                            <td> <img class="user_thumb" src="{{ asset('dashboard/images/invoice_img-man_2.png') }}" alt=""> </td>
                                            <td>Product</td>
                                            <td class="nowrap">Tom Smitn</td>
                                            <td class="nowrap">Client data test</td>
                                            <td>$125000</td>
                                        ...
                                        <tr>
                                            <td> <img class="user_thumb" src="{{ asset('dashboard/images/invoice_img-man_3.png') }}" alt=""> </td>
                                            <td>Product</td>
                                            <td class="nowrap">Tom Smitn</td>
                                            <td class="nowrap">Client data test</td>
                                            <td>$125000</td>
                                        ...
                                        <tr>
                                            <td> <img class="user_thumb" src="{{ asset('dashboard/images/invoice_img-man_4.png') }}" alt=""> </td>
                                            <td>Product</td>
                                            <td class="nowrap">Tom Smitn</td>
                                            <td class="nowrap">Client data test</td>
                                            <td>$125000</td>
                                            <td>High</td>
                                            <td>Oct</td>
                                            <td><img class="check_status" src="{{ asset('dashboard/images/invoice_img-close.png') }}" alt=""> </td>
                                            <td> 25/10/2020</td>
                                            <td> <button class="btn_1">PDF</button> </td>
                                        </tr>
                                        <tr>
                                            <td> <img class="user_thumb" src="{{ asset('dashboard/images/invoice_img-man_5.png') }}" alt=""> </td>
                                            <td>Product</td>
                                            <td class="nowrap">Tom Smitn</td>
                                            <td class="nowrap">Client data test</td>
                                            <td>$125000</td>
