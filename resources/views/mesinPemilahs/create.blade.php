                ...
                <div class="white_card_header">
                    <div class="box_header m-0">
                        <div class="main-title">
                            <h3 class="m-0">Form Tambah Mesin Pemilah</h3>
                        </div>
                    </div>
                </div>
                <div class="white_card_body">
                    <div class="QA_section">
                        <form action="{{ route('mesinPemilah.store') }}" method="POST">
                            @csrf
                            <div class="mb-3">
                                <label for="nama_mesin" class="form-label ">Nama Mesin</label>
                                <input type="text" class="form-control @error('nama_mesin') is-invalid @enderror" value="{{ old('nama_mesin') }}" id="nama_mesin" name="nama_mesin" required>
                                @error('nama_mesin')
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control @error('konfigurasi') is-invalid @enderror" value="{{ old('konfigurasi') }}" id="konfigurasi" name="konfigurasi" required>
                                @error('konfigurasi')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
