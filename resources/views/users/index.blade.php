                        ...
                        <div class="white_card_header">
                            <div class="box_header m-0">
                                <div class="main-title">
                                    <h3 class="m-0">Data user pengguna aplikasi STEM. <p>Berisi tentang nama pengguna, email, dan status 
                                        user apakah aktif atau tidak.
                                    </h3>
                                </div>
                            </div>
                        </div>
                        <div class="white_card_body">
                            <div class="QA_section">
                                <div class="white_box_tittle list_header">
                                    <a href="/user/create" class="btn btn-success btn-sm rounded-pill text-white"><i class="ti-plus me-2"></i> Tambah</a>
                                            ...
                                            <tr class="text-end">
                                                ...
                                                <td>
                                                    <div class="action_btns d-flex">
                                                        ...
                                                        <form action="{{ route('user.destroy', $item->id) }}" method="POST" onsubmit="return confirm('Yakin hapus user ini?')" class="d-inline">
                                                        @csrf
                                                        @method('DELETE')
